    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="../solicitud_login.php" method="POST"  class="sign-in-form">
        ...
        <p class="social-text"><a href="../../reset_contra/">Forgot Password?</a></p>
          ...
          <form action="../solicitud_registro.php" method="POST" class="sign-up-form">
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>MarketMinds Insights</h3>
            <p>
              No  Tienes Cuenta ?
              No Te Preocupes Registrate Aca
            </p>
            <button class="btn transparent" id="sign-up-btn">
              Sign up
            </button>
          </div>
          <img src="img/web1.webp" class="image" alt="" />
        </div>
        <div class="panel right-panel">
          <div class="content">
            ...
            <p>
              Ya Tienes  Cuenta ?
              Inicia Sesion en el Boton  de Abajo
            </p>

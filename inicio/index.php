...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"></script>
  ...
  <title>MarketMinds Insights Personal Blog</title>
        ...
        <div class="d-flex align-items-center">
            ...
            if (isset($_SESSION['username']) && isset($_SESSION['foto_perfil'])) {
                ...
                <div class="profile-info">
                    <img src="<?php echo $_SESSION['foto_perfil']; ?>" alt="Foto de perfil" class="profile-img" height="46px" width="46px" style="border-radius:50px;">
...
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ...
    echo '<img src="../admin/Dashboard/' . $imagen_url . '" alt="' . $autor . '" width="250" class="blog-banner-img">'; // Utilizamos la foto de perfil como imagen de la publicación
    echo '</div>';
    ...
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <a href="#" class="footer-logo">
          <img src="./assets/images/logo-light.svg" alt="MarketMinds Insights's Logo" width="150" class="logo-light">
          <img src="./assets/images/logo-dark.svg" alt="MarketMinds Insights's Logo" width="150" class="logo-dark">
        </a>
